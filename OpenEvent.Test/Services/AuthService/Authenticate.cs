...
namespace OpenEvent.Test.Services.AuthService
{
    ...
    public class Authenticate : AuthTestFixture
    {
        ...
        // {
        //     var result = await AuthService.Authenticate("exists@email.co.uk", "Password", false);
        ...
        // {
        //     FluentActions.Invoking(async () => await AuthService.Authenticate("exists@email.co.uk", "Wrong", false))
